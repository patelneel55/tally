...
class WeaviateVectorStore(IVectorStore):
    ...
    def get_vectorstore(self, embeddings: Embeddings) -> VectorStore:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to initialize LangChain VectorStore: {str(e)}") from e
    ...
    def add_documents(self, documents: List[Document], embeddings: Embeddings) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to add documents to vector store: {str(e)}") from e
    ...
    def add_texts(self, texts: List[str], metadatas: Optional[List[Dict]] = None, embeddings: Embeddings = None) -> List[str]:
    ...
    def similarity_search(self, query: str, k: int = 4, embeddings: Embeddings = None) -> List[Document]:
        ...
        try:
            ...
            result = (
                self._client.query
                .get(self.config.class_name, [self.config.text_field, self.config.metadata_field])
