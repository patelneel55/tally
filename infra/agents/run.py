...
if __name__ == "__main__":
    async def run():
        ...
        agent = DataIndexAgent(llm_provider=llm_provider, vector_store=vector_store, embedding_provider=embeddings)
        ...
        events = workflow.stream(
            {
                "messages": [
                    {"role": "user", "content": "What are the latest risk factors for Apple?"}
                ]
            },
