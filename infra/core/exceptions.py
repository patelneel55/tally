...
This module defines custom exceptions used throughout the infrastructure
layer. These exceptions provide specific error types for different failure
scenarios in data fetching and processing.
"""
...
class DataFetchError(Exception):
    ...
    def __init__(self, message: str, source: str = None, status_code: int = None):
        ...
        super().__init__(f"{message} (Source: {source}, Status: {status_code})" if source or status_code else message)
...
class ValidationError(Exception):
    ...
    def __init__(self, message: str, field: str = None, value: Any = None):
        ...
        self.field = field
        self.value = value
        super().__init__(f"{message} (Field: {field}, Value: {value})" if field or value else message)
