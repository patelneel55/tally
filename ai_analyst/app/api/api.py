...
from ai_analyst.app.api.endpoints import (
    sec_analysis,
    sec_routes,
    export,
    financial_modeling,
...
api_router.include_router(
    ...
    tags=["financial-modeling"]    # In the docs, these endpoints will be under "financial-modeling" section
)
...
api_router.include_router(
    ...
    tags=["utilities"]    # In the docs, these endpoints will be under "utilities" section
)
