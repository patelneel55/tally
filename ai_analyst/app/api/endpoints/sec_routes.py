...
from ai_analyst.app.services.sec_trends import sec_trends_analyzer
    ...
    try:
        ...
        for filing in filings:
            try:
                ...
                if filing.get("primaryDocument") and isinstance(filing.get("primaryDocument"), dict):
                    filing_data["document_url"] = filing.get("primaryDocument", {}).get("url")
