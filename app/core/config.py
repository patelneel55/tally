...
class Settings(BaseSettings):
    ...
    POLYGON_API_KEY: str = os.getenv("POLYGON_API_KEY", "5iq46sv8BkEtDKOUYeAVnTdqjXO44odg")  # For real-time financial data
    SEC_API_KEY: str = os.getenv("SEC_API_KEY", "e921f58fa84380083377ecee7781ba8945995f1e82112fb4b8593247f7408878")  # For SEC filings and documents
    ALPHA_VANTAGE_API_KEY: str = os.getenv("ALPHA_VANTAGE_API_KEY", "")  # For stock data and fundamentals
    OPENAI_API_KEY: str = os.getenv("OPENAI_API_KEY", "")  # For AI-powered analysis
    ANTHROPIC_API_KEY: str = os.getenv("ANTHROPIC_API_KEY", "")  # For Claude AI analysis
    ...
    SEC_FILING_CACHE_DIR: str = "cache/sec_filings"  # Directory to store downloaded filings
    SEC_ANALYSIS_CACHE_DIR: str = "cache/sec_analysis"  # Directory to store analysis results
    ...
    FINANCIAL_ANALYSIS_MODEL: str = "gpt-4o"  # AI model for financial analysis and modeling
    ...
    SEC_API_PREMIUM_CONCURRENT_REQUESTS: int = 10  # Maximum concurrent requests for premium tier
    SEC_API_PREMIUM_RATE_LIMIT: int = 20  # Requests per second for Query API (20 per second)
    SEC_API_PREMIUM_SEARCH_RATE_LIMIT: int = 10  # Requests per second for Full-Text Search API (10 per second)
    SEC_API_PREMIUM_EXTRACTOR_RATE_LIMIT: int = 10  # Requests per second for 10-K/10-Q/8-K Extractor API (10 per second)
    SEC_API_PREMIUM_FILING_DOWNLOAD_LIMIT: int = 7000  # Filings per 5 minutes for Filing Download API (7,000 in 5 minutes)
    SEC_API_PREMIUM_PDF_QUALITY: str = "high"  # PDF quality for premium tier (high/medium/low)
